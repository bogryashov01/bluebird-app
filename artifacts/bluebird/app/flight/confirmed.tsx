  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background, paddingTop: topPad, paddingBottom: bottomPad + 24 }]}>
      <View style={styles.content}>
        <Animated.View style={[styles.iconRing, { opacity: opacityAnim, transform: [{ scale: scaleAnim }] }]}>
          ...
          {[
            ...
            <React.Fragment key={row.label}>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={[styles.detailValue, { color: row.color, fontFamily: 'Inter_500Medium' }]}>{row.value}</Text>
              </View>
            </React.Fragment>
          ))}
        </View>
      ...
      <View style={styles.actions}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Text style={[styles.secondaryBtnText, { color: colors.mutedForeground, fontFamily: 'Inter_400Regular' }]}>Back to Discover</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  detailCard: {
    width: '100%', borderRadius: 16, borderWidth: 1, overflow: 'hidden',
  },
  detailRow: {
