...
const styles = StyleSheet.create({
  ...
  banner: { flexDirection: 'row', gap: 10, padding: 14, borderRadius: 12, borderWidth: 1, marginBottom: 4, alignItems: 'flex-start' },
  ...
  tierBadge: { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 10 },
