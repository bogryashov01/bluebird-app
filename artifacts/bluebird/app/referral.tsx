...
const styles = StyleSheet.create({
  ...
  heroCard: { padding: 20, borderRadius: 18, borderWidth: 1, gap: 14 },
  ...
  codeCard: { padding: 20, borderRadius: 18, borderWidth: 1, gap: 8 },
  ...
  statDivider: { width: 1 },
  shareBtn: { height: 56, borderRadius: 999, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 10 },
